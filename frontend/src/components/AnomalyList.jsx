                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      {anomaly.status === 'new' && (
                        <span className="px-3 py-2 rounded-xl text-sm font-bold font-mono bg-cyan-500/20 text-cyan-400 border border-cyan-400/40 cyber-pulse animate-pulse">
                          🚨 LIVE ALERT
                        </span>
                      )}
                      
                      {anomaly.source === 'real_time' && anomaly.status !== 'new' && (
                        <span className="px-3 py-2 rounded-xl text-sm font-bold font-mono bg-blue-500/20 text-blue-400 border border-blue-400/40">
                          📡 REAL-TIME
                        </span>
                      )}
